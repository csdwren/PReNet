...
parser.add_argument("--data_path",type=str, default="/media/r/BC580A85580A3F20/dataset/rain/peku/RainTrainH_wo_test",help='path to training data')
...
def main():
    ...
    # Build model
    model = Generator_PReNet(recurrent_iter=opt.recurrent_iter, use_GPU=opt.use_gpu)
    print_network(model)
